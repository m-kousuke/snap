...
public class GoCheckPeerAssessmentStudentServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		responseDataList = assessmentDAO.searchResponseDataByPeerAssessment(subjectStudentId, studentId, lessonId);
		request.setAttribute("responseDataList", responseDataList);

		getServletContext().getRequestDispatcher("/Public/student/checkRubric" + lessonId + "Peer.jsp").forward(request,
				response);
	}
}
