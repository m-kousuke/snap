...
<jsp:include page="../common/jsp/teacher.jsp" />

<div class="container">
	<div class="row" style="padding: 90px 0 0 0">
		<form action="./facilitation.jsp" method="POST">
						...
						<tbody>
							<%
								for (int i = 1; i <= lessonList.size(); i++) {
									out.println("<tr>");
									out.println("<td>");
									out.println(lessonList.get(i - 1).getSubject());
									out.println("</td>");
									out.println("<td>");
									...
									out.println("</td>");
									out.println("<td>");
									out.println("<button type='submit' class='btn btn-info btn-sm' name='lessonId' value="
											+ lessonList.get(i - 1).getId() + ">入力</button>");
									out.println("</td>");
									out.println("</tr>");
								}
							%>
